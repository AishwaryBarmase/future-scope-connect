          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-center">
                ...
                <span className="text-gray-400">123 Innovation Drive, Tech Park</span>
              </div>
              <div className="flex items-center">
                <Mail className="h-5 w-5 text-primary mr-2" />
                <a href="mailto:info@futurescope.ai" className="text-gray-400 hover:text-primary transition-colors">
                  info@futurescope.ai
                </a>
              </div>
              <div className="flex items-center">
